			...
			<SidebarContainer>
				<Wrapper>
					<Cont>
						...
						<div
							className='w-[220px] m-auto h-[40px] text-white justify-center bg-green-500 rounded-[10px] flex items-center mb-2 cursor-pointer'>
							{" "}
							Get Loans
						</div>
						<div className='h-[500px] w-[100%] bg-white flex-1  shadow-shadow rounded-[10px] p-3'>
							...
							<form
								...
								<select
									...
									<option value='MarketPadi' selected>
										Market Padi
									</option>
